...
## Arc <sub>_extends_</sub> [Ellipse](zh-cn/api/ellipse)
...
| --- | --- | --- | --- | --- |
| radius | | number | 0 | |
| _readonly_ radiusX | Ellipse | number | 0 | |
| _readonly_ radiusY | Ellipse | number | 0 | | 
| startAngle | | number | 0 | |
| endAngle | | number | 360 | |
| angle | | Array | [0, 360] | Shorthand of [startAngle, endAngle] |
| direction | | enum: {clockwise, anticlockwise} | clockwise | |
| closeType | | enum: {none, sector, normal} | none | |
