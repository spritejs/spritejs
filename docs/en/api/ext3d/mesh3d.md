...
Mesh3d defines a 3D model element.
...
| --- | --- | --- | --- | --- |
| mode | | string | TRIANGLES | Set drawing mode. |
| colors | | Color | #80808080 | Color of each vertex. |
| colorDivisor | | number | 3 | Each color value is assigned to how many vertices. |
| x | Node3d | number | 0 |  |
| y | Node3d | number | 0 |  |
| z | Node3d | number | 0 |  |
