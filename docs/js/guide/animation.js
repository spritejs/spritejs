  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          scene = new Scene('#transition-sequence', {
            viewport: ['auto', 'auto'],
            resolution: [1540, 600]
          });
          layer = scene.layer();
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          scene = new Scene('#transition-hover', {
            viewport: ['auto', 'auto'],
            resolution: [1540, 600]
          });
          _context2.next = 4;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          scene = new Scene('#animate-timeline', {
            viewport: ['auto', 'auto'],
            resolution: [1540, 600]
          });
          layer = scene.layer();
...
(function () {
  ...
  new TWEEN.Tween(coords).to({
    rotate: 360
  }, 5000).easing(TWEEN.Easing.Quadratic.Out).onUpdate(function () {
    ...
    var bgcolor = "rgb(".concat(red, ", ").concat(green, ", ").concat(blue, ")");
    sprite.attr({
      rotate: rotate,
      bgcolor: bgcolor
    });
