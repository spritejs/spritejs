...
(function () {
  var scene = new Scene('#load-texture', {
    viewport: ['auto', 'auto'],
    resolution: [1540, 600]
  });
  ...
  layer.append(robot);
  var label = new Label("\u56FE\u7247\u5927\u5C0F\uFF1A ".concat(robot.contentSize));
  label.attr({
    anchor: [0.5, 0.5],
    pos: [770, 100],
    font: '36px Arial'
  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          scene = new Scene('#preload-texture', {
            viewport: ['auto', 'auto'],
            resolution: [1540, 600]
          });
          _context.next = 3;
        ...
        case 3:
          ...
          layer.append(robot);
          label = new Label("\u56FE\u7247\u5927\u5C0F\uFF1A ".concat(robot.contentSize));
          label.attr({
            anchor: [0.5, 0.5],
            pos: [770, 100],
            font: '36px Arial'
      ...
      switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          earth.animate([{
            ...
            rotate: 360,
            textures: 'earth_yellow.png'
          }, {
            rotate: 720,
            textures: 'earth_green.png'
          }, {
            rotate: 1080,
            textures: 'earth_white.png'
          }, {
            rotate: 1440,
            textures: 'earth_blue.png'
          }], {
...
(function () {
  var scene = new Scene('#preload-many', {
    viewport: ['auto', 'auto'],
    resolution: [1540, 600]
  });
  var layer = scene.layer();
  ...
  function loadRes() {
    var imgs;
    return regeneratorRuntime.async(function loadRes$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            button.remove();
            scene.on('preload', function (evt) {
              label.text = "\u52A0\u8F7D\u4E2D... ".concat(evt.loaded.length, " / ").concat(evt.resources.length);
            });
            _context3.next = 4;
