...
(function () {
  var scene = new Scene('#d3-hierarchy', {
    viewport: ['auto', 'auto'],
    resolution: [1540, 1200]
  });
  ...
  d3.json('/res/data/city.json', function (err, data) {
    ...
    layer.selectAll('label[name!="region"]').data(nodes.descendants()).enter().append('label').attr('anchor', 0.5).attr('pos', function (d) {
      ...
      return "".concat(16 + Math.round(10 * Math.log2(d.value)), "px Arial");
