  ...
  (0, _createClass2.default)(Layer, [{
    ...
    value: function updateGlobalTransform() {
      if (this.layerTransformInvert) {
        ...
        renderer.setGlobalTransform.apply(renderer, (0, _toConsumableArray2.default)(_glMatrix.mat2d.multiply(mOut, globalMatrix, this.transformMatrix)));
      }
    }
    /* override */
    ...
    get: function get() {
      ...
      this[_layerTransformInvert] = _glMatrix.mat2d.invert(Array.of(0, 0, 0, 0, 0, 0), m);
