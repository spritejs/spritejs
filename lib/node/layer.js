...
var Layer = /*#__PURE__*/function (_Group) {
  ...
  (0, _createClass2.default)(Layer, [{
    ...
    value: function setLayerTransform() {
      ...
      this[_layerTransformInvert] = this[_layerTransform] && _glMatrix.mat2d.invert(Array.of(0, 0, 0, 0, 0, 0), m); // m = m || mat2d(1, 0, 0, 1, 0, 0);
      ...
      var mOut = _glMatrix.mat2d.fromValues(1, 0, 0, 1, 0, 0);

      renderer.setGlobalTransform.apply(renderer, (0, _toConsumableArray2.default)(_glMatrix.mat2d.multiply(mOut, globalMatrix, m)));
      this.forceUpdate();
    }
    /* override */
