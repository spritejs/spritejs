...
function (_Group) {
  ...
  function Scene() {
    ...
    options.displayRatio = options.displayRatio || ((typeof window === "undefined" ? "undefined" : (0, _typeof2.default)(window)) && window.devicePixelRatio ? window.devicePixelRatio : 1.0);
  ...
  (0, _createClass2.default)(Scene, [{
    ...
    value: function appendChild(layer) {
      if (!(layer instanceof _layer.default) && !(layer instanceof _layerWorker.default)) {
        wrapLayer(layer);
      }
