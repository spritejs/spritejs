    ...
    */
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(drawingContext) {
        ...
        var t = arguments[2];
        var transform, pos, bound, context;
    ...
    value: function render(t, drawingContext) {
      ...
      if (bgcolor || linearGradients && linearGradients.bgcolor) {
        ...
        boxctx.beginPath();
        boxctx.moveTo(_x11 + _r, _y);
        boxctx.arcTo(_x11 + _w, _y, _x11 + _w, _y + _h, _r);
        boxctx.arcTo(_x11 + _w, _y + _h, _x11, _y + _h, _r);
        boxctx.arcTo(_x11, _y + _h, _x11, _y, _r);
        boxctx.arcTo(_x11, _y, _x11 + _w, _y, _r);
        boxctx.closePath();
