...
class BaseSprite extends BaseNode {
  ...
  static defineAttributes(attrs) {
    ...
    //Object.assign(SubAttr.prototype, attrs)
    const descriptors = Object.getOwnPropertyDescriptors(attrs)
    Object.defineProperties(SubAttr.prototype, descriptors)
    this.Attr = SubAttr
  }
  ...
  constructor(opts = {attr: {}}) {
    ...
    this[_context] = null
    this[_renderers] = [] // 通过 draw 方法直接操作 context，一次性加上的
    this[_paths] = []
  }
  ...
  cloneNode() {
    ...
    node.initAttributes(this[_attr][_attrSym])
    return node
  }
  set id(val) {
    this.attr('id', val)
