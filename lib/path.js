  ...
  render(t) {
    ...
    if(attr.d) {
      ...
      if(linearGradients && linearGradients.strokeColor) {
        context.strokeStyle = getLinearGradients(context, [borderWidth, borderWidth,
          width, height], linearGradients.strokeColor)
      } else {
      ...
      if(attr.renderMode === 'fill') {
        if(linearGradients && linearGradients.fillColor) {
          context.fillStyle = getLinearGradients(context, [borderWidth, borderWidth,
            width, height], linearGradients.fillColor)
        } else {
