...
var _sprite = _interopRequireDefault(require("sprite-core/src/core/sprite"));
      ...
      value: function value(textures) {
        ...
        textures = textures.map(function (texture) {
          if (typeof texture === 'string') {
            ...
            var id = (0, _utils.generateID)(texture);
...
}, _sprite.default.Attr);

_sprite.default.Attr = ResAttr;
var _default = _sprite.default;
