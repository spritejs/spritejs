  ...
  delegateEvent(...events) {
    events.forEach((event) => {
      ...
      this.container.addEventListener(type, (e) => {
        ...
        let mouseX = e.layerX != null ? e.layerX : e.offsetX
        let mouseY = e.layerY != null ? e.layerY : e.offsetY
        ...
        let [layerX, layerY] = this.toLocalPos(mouseX, mouseY)

        Object.assign(evtArgs, {layerX, layerY, mouseX, mouseY})
