...
function (_BaseNode) {
  ...
  (0, _createClass2.default)(Scene, [{
    ...
    value: function preload() {
      ...
      return _regenerator.default.async(function preload$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _regenerator.default.awrap(Promise.all(tasks));
    ...
    value: function snapshot() {
      ...
      return _regenerator.default.async(function snapshot$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 10;
              return _regenerator.default.awrap(Promise.all(renderTasks));
