...
var _utils = require("sprite-core/src/utils");
...
function (_BaseNode) {
  ...
  function Scene(container) {
    ...
    container.scene_ = (0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this));
    /* istanbul ignore if */

    if (arguments.length === 3) {
      (0, _utils.setDeprecation)('Scene(container, width, height)', 'Instead use Scene(container, {viewport, resolution}).');
    ...
    Object.defineProperty((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), 'ownerDocument', {
      get: function get() {
        return {
  ...
  (0, _createClass2.default)(Scene, [{
    ...
    value: function insertBefore(newchild, refchild) {
      ...
      this[_layers] = (0, _utils.sortOrderedSprites)(Object.values(this[_layerMap]), true);
    }
  }, {
    key: "replaceChild",
    ...
    value: function querySelector(selector) {
      return (0, _dom.querySelector)(selector, this);
    }
  }, {
    key: "querySelectorAll",
    value: function querySelectorAll(selector) {
      return (0, _dom.querySelectorAll)(selector, this);
    }
  }, {
    key: "snapshot",
    value: function () {
