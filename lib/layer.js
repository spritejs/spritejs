...
function (_Layer) {
  ...
  function ExLayer(id) {
    ...
    if (context.canvas && context.canvas.addEventListener) {
      context.canvas.addEventListener('mouseleave', function (evt) {
        ...
        var layers = _this.parent ? _this.parent.sortedChildNodes : [(0, _assertThisInitialized2.default)(_this)];
    ...
    if (resolution) {
      ...
      _this.resolution = [].concat((0, _toConsumableArray2.default)(resolution), [0, 0]);
    } else {
  ...
  (0, _createClass2.default)(ExLayer, [{
    ...
    value: function takeSnapshot() {
      ...
      return _regenerator.default.async(function takeSnapshot$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _regenerator.default.awrap(this.prepareRender());
    ...
    value: function putSnapshot(snapshot) {
      ...
      snapshot.children.forEach(function (child) {
        var node = (0, _core.createNode)(child.nodeType);
    ...
    set: function set(resolution) {
      this[_resolution] = [].concat((0, _toConsumableArray2.default)(resolution), [0, 0]).slice(0, 4);
